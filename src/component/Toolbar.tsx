    ...
    return (
        <>
            <nav className='Nav1 relative rounded-b-2xl bg-MybackColor border-gray-200 g-gray-900'>
                <div
                    className='div1 max-w-screen-xl flex flex-wrap items-center
        justify-between mx-auto pt-2 pb-2 pl-4 pr-4'>
                    <a
                        ...
                        <span className='TollBarTitle self-center  text-3xl font-extrabold  whitespace-nowrap text-white'>
                            Ani
                            <strong className='Fire text-2.2xl font-250 text-piramy'>
                                fire
                            </strong>
                        </span>
                    </a>
                    <button
                        ...
                        type='button'
                        className='tollbarBtn inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg  focus:outline-none focus:ring-2 text-white hover:bg-gray-700 focus:ring-gray-600'
                        aria-controls='navbar-default'
                        aria-expanded='false'
                        onClick={OpenBtmSheet}>
