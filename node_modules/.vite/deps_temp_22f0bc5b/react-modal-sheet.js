...
var $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document !== "undefined" ? (0, import_react48.default).useLayoutEffect : () => {
};
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react51.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react51.default).createContext(false);
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react51.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react51.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react51.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id3 = (0, import_react51.default).useId();
  let [didSSR] = (0, import_react51.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id3}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react51.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react51.default)["useSyncExternalStore"] === "function") return (0, import_react51.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react51.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
var $ea8dcbcb9ea1b556$var$RouterContext = (0, import_react53.createContext)({
  isNative: true,
...
var useIsomorphicLayoutEffect2 = IS_SSR ? import_react65.useEffect : import_react65.useLayoutEffect;
...
function useEventCallbacks(isOpen, callbacks) {
  const prevOpen = usePrevious(isOpen);
  const didOpen = (0, import_react65.useRef)(false);
  const handleAnimationComplete = (0, import_react65.useCallback)(() => {
    var _a, _b, _c, _d;
    if (!didOpen.current) {
...
function useDimensions() {
  const [dimensions, setDimensions] = (0, import_react65.useState)({ height: 0, width: 0 });
...
function useEffectEvent(handler) {
  const handlerRef = (0, import_react65.useRef)();
  useIsomorphicLayoutEffect2(() => {
...
function useDragConstraints() {
  const constraintsRef = (0, import_react65.useRef)(null);
  const onMeasureDragConstraints = (0, import_react65.useCallback)(() => constraints, []);
  return { constraintsRef, onMeasureDragConstraints };
}
var SheetContext = (0, import_react65.createContext)(
  void 0
);
var useSheetContext = () => {
  const context = (0, import_react65.useContext)(SheetContext);
  if (!context)
    throw Error("Sheet context error");
  return context;
};
var SheetScrollerContext = (0, import_react65.createContext)(void 0);
function SheetScrollerContextProvider({
  children
}) {
  const sheetContext = useSheetContext();
  const [disableDrag, setDisableDrag] = (0, import_react65.useState)(!!sheetContext.disableDrag);
...
var useSheetScrollerContext = () => {
  const context = (0, import_react65.useContext)(SheetScrollerContext);
  if (!context)
...
var Sheet = (0, import_react65.forwardRef)(
  ({
    onOpenStart,
    onOpenEnd,
    onClose,
    ...
    const sheetRef = (0, import_react65.useRef)(null);
    ...
    const callbacks = (0, import_react65.useRef)({
      onOpenStart,
      onOpenEnd,
      onCloseStart,
      onCloseEnd
    ...
    const dragProps = (0, import_react65.useMemo)(() => {
      const dragProps2 = {
        drag: "y",
        dragElastic: 0,
        dragMomentum: false,
    ...
    const sheet = import_react65.default.createElement(SheetContext.Provider, { value: context }, import_react65.default.createElement(
      motion.div,
      {
        ...rest,
        ref,
      ...
      import_react65.default.createElement(AnimatePresence, null, isOpen ? import_react65.default.createElement(SheetScrollerContextProvider, null, import_react65.Children.map(
        children,
        (child, i) => (0, import_react65.cloneElement)(child, { key: `sheet-child-${i}` })
      )) : null)
    ));
    if (IS_SSR)
      return sheet;
...
var SheetContainer = (0, import_react65.forwardRef)(
...
var SheetContent = (0, import_react65.forwardRef)(
...
var SheetHeader = (0, import_react65.forwardRef)(
  ({ children, style, disableDrag, ...rest }, ref) => {
    ...
    return import_react65.default.createElement(
      ...
      children || import_react65.default.createElement("div", { className: "react-modal-sheet-header", style: styles_default.header }, import_react65.default.createElement(
        motion.span,
        {
...
var SheetBackdrop = (0, import_react65.forwardRef)(
...
var SheetScroller = (0, import_react65.forwardRef)(
